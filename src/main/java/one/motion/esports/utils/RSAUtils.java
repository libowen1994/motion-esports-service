...
public class RSAUtils {
    ...
    public static boolean verify(String decryptData, String publicKey) {
        try {
            ...
            SortedMap<String, Object> signParams = new TreeMap<>(context.getJSONObject("businessContext"));
            return verify(JSONObject.toJSONString(signParams), publicKey, context.getJSONObject("businessHead").getString("sign"));
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public static String decryptByPrivateKey(String encryptedData, String privateKey) throws Exception {
        privateKey = privateKey.replaceAll("\n", "");
        return new String(decryptByPrivateKey(Base64.decodeBase64(encryptedData), privateKey), CHARSET_NAME);
    }
    ...
    public static String encryptByPublicKey(String data, String publicKey) throws Exception {
        publicKey = publicKey.replaceAll("\n", "");
        return Base64.encodeBase64String(encryptByPublicKey(data.getBytes(CHARSET_NAME), publicKey));
    }
    ...
    public static String verify(Map<String, Object> context, String rsaPrivateKey) throws Exception {
        SortedMap<String, Object> signParams = new TreeMap<>(context);
        return RSAUtils.sign(JSON.toJSONString(signParams), rsaPrivateKey);
    }
    ...
    public static String encryption(JSONObject context, String rsaPrivateKey) throws Exception {
        SortedMap<String, Object> signParams = new TreeMap<>(context);
        return sign(JSON.toJSONString(signParams), rsaPrivateKey);
    }
